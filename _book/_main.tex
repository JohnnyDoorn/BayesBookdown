...
{\centering \includegraphics[width=0.9\linewidth]{_main_files/figure-latex/two-models-binomial-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{_main_files/figure-latex/two-models-likelihoods-binomial-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{_main_files/figure-latex/two-models-binomial-onesided-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{_main_files/figure-latex/two-models-binomial-onesided-predictions-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{_main_files/figure-latex/uninformed-model-binomial-prediction-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{_main_files/figure-latex/uninformed-model-binomial-prediction-2-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{_main_files/figure-latex/likelihood-binomial-8-heads-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{_main_files/figure-latex/likelihood-binomial-8-heads-marginal-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{_main_files/figure-latex/likelihood-binomial-8-heads-marginal-redgreen-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{_main_files/figure-latex/prior-posterior-binomial-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{_main_files/figure-latex/sarah-model-binomial-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{_main_files/figure-latex/david-model-binomial-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{_main_files/figure-latex/likelihood-binomial-8-heads-marginal-david-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{_main_files/figure-latex/prior-posterior-binomial-david-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{_main_files/figure-latex/prior-posterior-binomial-david-alt-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{_main_files/figure-latex/prior-posterior-binomial-sd-ratio-1} 
...
{\centering \includegraphics[width=1\linewidth]{_main_files/figure-latex/three-cauchy-dists-1} 
...
{\centering \includegraphics[width=1\linewidth]{_main_files/figure-latex/beer-t-test-likelihood-1} 
...
{\centering \includegraphics[width=1\linewidth]{_main_files/figure-latex/three-stretched-beta-dists-1} 
...
{\centering \includegraphics[width=1\linewidth]{_main_files/figure-latex/beer-correlation-likelihood-1} 
